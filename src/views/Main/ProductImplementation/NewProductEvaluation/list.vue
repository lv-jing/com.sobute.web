    ...
    <el-card class="box-card" shadow="never">
      ...
      <div class="user-form-table mt20">
        <el-button
          ...
          @click="$router.push({name:'newProductEvaluation',query:{type:'add'}})"
        >新增</el-button>
        <el-table
          class="mt10"
          :data="tableData"
        ...
        >
          <el-table-column prop="evaluationNumber" width="100" label="编号"></el-table-column>
          ...
          <el-table-column label="操作" align="center" width="180">
            <template v-slot="{row}">
              <common-operation
                :row="row"
                :deletUrl="deletUrl"
                :getPageList="getEvaluationList"
                pageUrlName="newProductEvaluation"
...
<script>
/* eslint-disable */
import { getEvaluationList, getEvaluationDelete } from "@/service/pilot";
...
export default {
  ...
  methods: {
    ...
    async getEvaluationList() {
      const { code, data, total } = await getEvaluationList({
        ...this.searchForm,

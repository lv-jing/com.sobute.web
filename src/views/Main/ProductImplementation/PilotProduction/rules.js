...
export function addFormRule(_this) {
  return [
    ...
    {
      "type": "input", "field": "productionNumber", "title": "试生产编号", "value": "",
      props: {
        placeholder: "",
        disabled: true
      },
    ...
    },
    {
      ...
      validate: [{required: true, message: '请输入试生产目标', trigger: 'blur'},],
    },
    ...
    },
    {
      ...
      validate: [{required: true, message: '请输入试生产设备及场地需求', trigger: 'blur'},],
    },
    ...
    },
    {
      ...
      validate: [{required: true, message: '请输入试生产人员需求', trigger: 'blur'},],
    },
    ...
    },
    {
      ...
      name: 'title',
      props: {
        content: `1. 申请人：提出申请时，必传“小试/中试总结报告”、“小试/中试工艺文件（含工艺流程、操作步骤、安全注意事项、检验方法等）”、“安环评估及注意事项”；小试/中试结束后，必传“小试/中试总结报告”
            <br>2. 总工：组织线下评审
            <br>3. 配方管理：提供新增物料和配方的编码和名称（EBS中创建和分配）
            <br>4. 基地负责人：组织实施，并指定实施负责人；小试/中试结束后，反馈新增原材料与小试/中试产品是否能处理？`
      },
    },
    // {
    //   type: 'common-title',

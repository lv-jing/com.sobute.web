    ...
    <el-card class="box-card" shadow="never">
      ...
      <div class="user-form-table mt20">
        <el-button
          ...
          @click="$router.push({name:'approval',query:{type:'add'}})"
        >新增</el-button>
        <el-table
          class="mt10"
          :data="tableData"
...
import { getProjectList, deleteProList, getUserType } from "@/service/approval";
import { getDownLoadWords } from "@/service/common";

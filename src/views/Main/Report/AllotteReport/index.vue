        ...
        <el-card class="box-card" shadow="never">
            ...
            <div class="user-form-table mt20">
                ...
                >
                    ...
                    <el-table-column prop="name" label="来文名称"></el-table-column>
                    <el-table-column prop="documentDate" label="发文日期" width="100px"></el-table-column>
                    <el-table-column prop="toDo" label="待办事项"></el-table-column>
                    <el-table-column prop="deadline" label="处理期限" width="100px"></el-table-column>
...
<script>
    import {
        getList,
    } from "@/service/report/AllotteReport";

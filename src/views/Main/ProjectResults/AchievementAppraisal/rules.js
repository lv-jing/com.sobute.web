...
export const addFormRule=(type) =>  [
    ...
    {
        "type": "input", "field": "organization", "title": "鉴定专家", "value": "",
        props: {
            placeholder: "请输入"
        },
        col: {
    ...
    {
        "type": "DatePicker", "field": "confirmDate", "title": "鉴定日期", "value": "",
        props: {
            placeholder: "请输入"
        },
        col: {
    ...
    {
        "type": "input", "field": "party", "title": "完成单位", "value": "",
        props: {
            placeholder: "请输入"
        },
        col: {
    ...
    {
        "type": "input", "field": "register", "title": "鉴定单位", "value": "",
        props: {
            placeholder: "请输入"
        },
        col: {
    ...
    // },
    {
        "type": "input", "field": "employ", "title": "成果水平", "value": "",
        props: {
            placeholder: "请输入"
        },
        col: {
    ...
    {
        "type": "input", "field": "comments", "title": "鉴定意见", "value": "",
        props: {
            placeholder: "请输入",
            type:"textarea",
            rows: 4,

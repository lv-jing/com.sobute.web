...
export const addFormRule=(type) => [
    ...
    {
        "type": "input", "field": "author", "title": "全部作者", "value": "",
        props: {
            placeholder: "按顺序录入全部作者姓名，以中文输入、“，”分隔"
        },
        col: {
            span: 8,
            labelWidth: '100px'
    ...
    {
        "type": "input", "field": "organization", "title": "著/编", "value": "",
        props: {
            placeholder: "请输入"
        },
        col: {
    ...
    {
        "type": "DatePicker", "field": "confirmDate", "title": "出版日期", "value": "",
        props: {
            placeholder: "请输入"
        },
        col: {
    ...
    {
        "type": "input", "field": "party", "title": "出版社", "value": "",
        props: {
            placeholder: "请输入"
        },
        col: {

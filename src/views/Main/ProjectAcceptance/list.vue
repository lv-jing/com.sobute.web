    ...
    <el-card class="box-card" shadow="never">
      ...
      <div class="user-form-table mt20">
        ...
        <el-table
          ...
          size="small"
        >
          <el-table-column prop="documentNumber" width="80" label="验收编号"></el-table-column>
          ...
          <el-table-column prop="fillDate" label="验收日期"></el-table-column>
...
export default {
  ...
  methods: {
     ...
     */
    addDeclaration() {
      this.$router.push({ name: "acceptManage", query: { type: "add" } });
    },
    /**
     * 查询
     */

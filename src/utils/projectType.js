...
export const funType = [{
  ...
  value: 'approved-pg-batch',
  label: '中试'
},  {
  value: 'approved-pg-batch-apply',
  label: '试生产'
}, {
  value: 'approved-pg-evaluation',
  label: '新产品评价'
},  {
  value: 'approved-pg-process',
  label: '工艺管理'
},  {
  value: 'project-check',
  label: '项目验收'
...
export const projectType = {
  ...
  "approved-pg-batch": "pilotTest",
  "approved-pg-batch-apply": "pilotProduction",
  "approved-pg-evaluation":"newProductEvaluation",
  "approved-pg-process":"processManagement",
  ...
  "approved_rpm_ps_headers": "PersonalSummary",
